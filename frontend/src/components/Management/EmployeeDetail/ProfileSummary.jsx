    ...
    function ExtraEmployeeInfo() {
        return (
            <>
                ...
                {
                    /* Birth date */
                    employee.employee.dateOfBirth != null &&
                    <>
                        ...
                        <p>{moment(employee.employee.dateOfBirth).format('D MMMM YYYY')}</p>
                    </>
                }
            </>
        )
            ...
            <div className="p-6">
                <div className="grid place-self-center md:place-self-start mb-5">
                    ...
                    {employee.employee != null ?
                        <>
                            <span className={`badge ${statusSwitch(employee.employee.employmentStatus)}`}>{employee.employee.employmentStatus}</span>
                        </>
                        :
