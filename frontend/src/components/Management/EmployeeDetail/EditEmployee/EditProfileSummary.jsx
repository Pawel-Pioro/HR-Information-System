    ...
    function ExtraEmployeeInfo() {
        return (
            <>
                ...
                <input placeholder='Phone number' className='input text-base' type="text" value={employeeInputValues.phoneNumber} onChange={(e) => setEmployeeInputValues({ ...employeeInputValues, phoneNumber: e.target.value })} />
                ...
                <input placeholder="Job Title" type="text" value={employeeInputValues.jobTitle} onChange={(e) => setEmployeeInputValues({ ...employeeInputValues, jobTitle: e.target.value })} className="input" />
                ...
                <input placeholder="Date of Birth" type="date" value={employeeInputValues.dateOfBirth} onChange={(e) => setEmployeeInputValues({ ...employeeInputValues, dateOfBirth: e.target.value })} className="input" />
            </>
        )
    }
        ...
        <div className="card card-border bg-base-200 w-full ">
            <div className="p-6">
                <div className="grid place-self-center md:place-self-start mb-5">
                    ...
                    <div className='flex flex-col gap-1 md:flex-row max-w-[300px]'>
                        <input placeholder='First Name' type="text" value={userInputValues.first_name} onChange={(e) => { setUserInputValues({ ...userInputValues, first_name: e.target.value }) }} className="font- text-2xl mb-2 input" />
                        <input placeholder='Last Name' type="text" value={userInputValues.last_name} onChange={(e) => { setUserInputValues({ ...userInputValues, last_name: e.target.value }) }} className="font- text-2xl mb-2 input" />
                    </div>
                ...
                <div className="grid grid-cols-[30px_auto] gap-y-2 place-self-center md:place-self-start items-center">
                    ...
                    <input placeholder='Email' type="text" value={userInputValues.email} onChange={(e) => { setUserInputValues({ ...userInputValues, email: e.target.value }) }} className="text-base input" />
