                ...
                <div className="mt-3">
                    ...
                    <div className="stats">
                        <div className="stat place-items-center">
                            ...
                            <input min={0} className="input w-1/2 font-extrabold text-center text-xl" type="number" value={employeeInputValues.leaveBalance} onChange={(e) => { setEmployeeInputValues({ ...employeeInputValues, leaveBalance: e.target.value }) }} />
