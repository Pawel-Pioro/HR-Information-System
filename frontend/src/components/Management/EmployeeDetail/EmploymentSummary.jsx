    ...
    <div className="card card-border bg-base-200 w-full">
      <div className="grid p-6 place-items-center">
        ...
        <div className="mt-3">
          ...
          {employee.employee.manager_detail && <p><span className="font-bold pr-3">Manager</span>{employee.employee.manager_detail.first_name} {employee.employee.manager_detail.last_name}</p>}
